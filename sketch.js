...
function setup() {
  ...
  //first level
  BlockBlue1 = new Boxblue(200, 182, 20, 20);

  BlockBlue2 = new Boxblue(220, 182, 20, 20);

  BlockBlue3 = new Boxblue(240, 182, 20, 20);

  BlockBlue4 = new Boxblue(260, 182, 20, 20);

  BlockBlue5 = new Boxblue(280, 182, 20, 20);

  BlockBlue6 = new Boxblue(300, 182, 20, 20);

  BlockBlue7 = new Boxblue(320, 182, 20, 20);
